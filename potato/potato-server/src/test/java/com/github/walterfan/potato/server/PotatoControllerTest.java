...
import com.github.walterfan.potato.server.config.WebConfig;
...
public class PotatoControllerTest {
	...
	public void testPing() throws Exception {
		...
		assertEquals(serviceHealth.getServiceName(), "potato-service");
		//the dependency service potato-scheduler is not ready
		assertEquals(serviceHealth.getServiceState(), ServiceState.DOWN );
